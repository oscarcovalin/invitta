...
export function LodgingSuggestions() {
  return (
    <section id="lodging" className="py-24 px-margin-mobile bg-[#FAF8F5] relative overflow-hidden border-t border-b border-outline-variant/15">
          ...
          {HOTEL_SUGGESTIONS.map((hotel, i) => (
            ...
            >
              <div className="space-y-6">
                ...
                <div className="space-y-3 text-xs border-t border-stone-200/50 pt-4">
                  {/* Location Info */}
                  <div className="flex items-start gap-2.5 text-[#454841] font-light leading-relaxed">
                    <MapPin className="w-4 h-4 text-sage flex-shrink-0 mt-0.5" />
                    <span>{hotel.address}</span>
                  </div>

                  {/* Contact Info */}
                  <div className="flex items-center gap-2.5 text-[#454841]">
              ...
              <div className="pt-8">
                <a
                  ...
                  className="w-full py-3 bg-[#211a18] text-[#f4efe9] hover:bg-champagne-gold hover:text-ink text-[10px] tracking-[0.25em] font-semibold uppercase rounded-xs transition-all duration-300 flex items-center justify-center gap-1.5 cursor-pointer shadow-md"
                >
