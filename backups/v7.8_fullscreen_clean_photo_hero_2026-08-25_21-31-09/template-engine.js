...
<div class="flex flex-col w-full overflow-hidden relative">
  ...
  <section id="hero" class="relative ${hasHeroPhoto ? 'pt-0 pb-12' : 'min-h-[68vh] sm:min-h-[72vh] flex flex-col items-center justify-center pt-10 pb-6 px-margin-mobile'} text-center" style="overflow: visible;">
    ...
    <!-- ╚══════════════════════════════════════════════════════════════╝ -->
    <div id="heroPhotoFrame" class="w-full relative h-[82vh] sm:h-[88vh] overflow-hidden mb-8 shadow-[0_20px_50px_rgba(0,0,0,0.12)]">
      <div id="parallaxBgHero" class="absolute inset-0 w-full h-[120%] -top-[10%] will-change-transform">
        <img id="heroPhotoImg" src="${config.photos.hero}" alt="${safeTitle}" class="w-full h-full object-cover object-center" loading="eager"/>
      </div>
      <!-- Difuminado inferior elegante hacia el fondo marfil/champán -->
      <div class="absolute inset-x-0 bottom-0 h-36 bg-gradient-to-t from-champagne-cream via-champagne-cream/70 to-transparent pointer-events-none"></div>
    </div>

    <!-- ╔══════════════════════════════════════════════════════════════╗ -->
    <!-- ║  TEXTOS DEBAJO DE LA FOTOGRAFÍA (MÁXIMA LEGIBILIDAD)         ║ -->
    <!-- ╚══════════════════════════════════════════════════════════════╝ -->
    <div class="relative z-10 flex flex-col items-center gap-4 max-w-lg mx-auto gsap-fade-up w-full px-margin-mobile mt-2">
      
      <!-- VIP Guest Banner -->
      <div id="vipBanner" class="hidden flex-col items-center gap-0.5 px-6 py-2 bg-white/85 backdrop-blur-md rounded-full border border-antique-gold/40 shadow-md mb-1">
