...
const TemplateEngine = {
  ...
  defaultConfig: {
    ...
    vendorCard: {
      ...
      showAgencyNote: true,
      agencyName: "Diseño Exclusivo · Invitaciones Digitales"
    }
  },
...
<footer class="pt-16 pb-24 px-margin-mobile text-center bg-emerald-deep border-t border-antique-gold/30">
  ...
  <div id="vendorCard" class="mt-12 pt-8 border-t border-antique-gold/20 max-w-sm mx-auto gsap-fade-up ${(vendorCard.enabled !== false) ? '' : 'hidden'}">
    <p class="font-label-caps text-[10px] sm:text-[10.5px] text-antique-gold tracking-[0.25em] uppercase mb-1.5 font-semibold" id="vendorCardBadge">
    ...
    <span class="font-label-caps text-[9px] text-[#f7f6ec]/40 tracking-widest uppercase block mt-3" id="vendorCardAgency">
