...
<style>
  ...
  .pergamino-container {
    background: #ffffff;
    border: 1px solid rgba(163, 128, 71, 0.4);
    border-radius: 18px;
    padding: 38px 26px;
    width: 92%;
    max-width: 480px;
    margin: 0 auto;
    box-shadow: 0 14px 40px rgba(0, 0, 0, 0.08), 0 2px 8px rgba(0, 0, 0, 0.04);
  ...
  .form-group-clean input:focus, .form-group-clean select:focus {
    ...
    box-shadow: 0 0 0 3px rgba(163, 128, 71, 0.15);
  ...
  .btn-rsvp-submit-clean {
    ...
    box-shadow: 0 4px 14px rgba(163, 128, 71, 0.25);
    margin-top: 10px;
  }
  ...
  <section id="rsvp" class="pt-16 pb-36 px-margin-mobile bg-emerald-dark text-center relative overflow-hidden border-t border-antique-gold/30 ${isRsvpEnabled ? '' : 'hidden'}">
    ...
    <div class="relative z-10 max-w-md mx-auto gsap-scale-up overflow-visible">
      ...
      <div class="pergamino-container text-deep-onyx" id="pergaminoCard">
        ...
        <h2 class="font-display-lg text-2xl sm:text-3xl font-normal text-deep-onyx mb-1 tracking-wide uppercase" id="tituloRsvpPergamino">
          ${(config.rsvp && config.rsvp.title) || config.rsvpTitle || 'Confirmación de Asistencia'}
        </h2>
