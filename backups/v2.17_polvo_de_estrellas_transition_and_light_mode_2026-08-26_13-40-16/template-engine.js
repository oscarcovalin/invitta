...
<div class="flex flex-col w-full overflow-hidden relative">
  ...
  <section id="details" class="${detailsPaddingTop} pb-20 px-margin-mobile text-center max-w-3xl mx-auto relative overflow-hidden ${isLocationsEnabled ? '' : 'hidden'}">
    ...
    <div class="space-y-12 max-w-lg mx-auto gsap-stagger-container">
      ...
      <!-- ==================== TRANSICIÓN: POLVO DE ESTRELLAS ==================== -->
      <div id="stardustTransition" class="relative my-8 py-8 px-6 sm:px-8 rounded-2xl bg-gradient-to-b from-black/60 via-black/75 to-black/60 border border-antique-gold/50 shadow-[0_10px_35px_rgba(165,110,14,0.18)] overflow-hidden text-center gsap-fade-up ${isStardustEnabled ? '' : 'hidden'}">
        ...
        <div class="relative z-10 flex flex-col items-center">
          ...
          <h3 class="font-display-lg text-[22px] sm:text-[26px] font-normal text-[#f7f6ec] tracking-wide mb-1.5" id="stardustTitle">
          ...
          <p class="font-display-lg text-[14.5px] sm:text-[16px] text-[#f7f6ec]/90 max-w-md mx-auto leading-relaxed font-light mb-6 tracking-wide" id="stardustText">
          ...
          <button type="button" id="btnOpenStardustLight" class="btn-luxury-primary text-[11.5px] sm:text-[12.5px] py-3 px-7 uppercase tracking-[0.25em] font-semibold inline-flex items-center gap-2.5 shadow-[0_0_25px_rgba(212,175,55,0.45)] hover:shadow-[0_0_35px_rgba(212,175,55,0.75)] transition-all transform hover:scale-105 active:scale-95 cursor-pointer">
  ...
  <section id="rsvp" class="py-24 px-margin-mobile bg-emerald-dark text-center relative overflow-hidden border-t border-antique-gold/30 ${isRsvpEnabled ? '' : 'hidden'}">
    ...
    <div class="relative z-10 max-w-md mx-auto gsap-scale-up overflow-visible">
      <!-- RSVP como elemento gráfico tipográfico editorial de gran escala con total coherencia dorada -->
      <p class="font-display-lg text-[52px] sm:text-[64px] md:text-[76px] font-light tracking-[0.16em] uppercase leading-none overflow-visible text-antique-gold select-none mb-2"
        style="color: var(--color-gold, #c19a4e); text-shadow: 0 2px 14px rgba(0,0,0,0.5);">
        RSVP
      </p>
      <h2 class="font-display-lg text-[26px] sm:text-[30px] md:text-[34px] mb-3 font-normal gsap-title overflow-visible text-[#f7f6ec] tracking-wide">
        Confirma tu Asistencia
      </h2>
      <p id="rsvpDeadline" class="font-display-lg text-[15.5px] sm:text-[17px] text-[#f7f6ec]/85 mb-8 gsap-fade-up font-light tracking-wide">
