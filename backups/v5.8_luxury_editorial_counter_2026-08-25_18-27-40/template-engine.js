...
<div class="flex flex-col w-full overflow-hidden relative">
  ...
  <section id="countdownSection" class="${countdownPaddingTop} pb-20 px-margin-mobile text-center relative max-w-lg mx-auto gsap-fade-up">
    ...
    <div id="countdownWrapper" class="flex flex-col items-center w-full max-w-[420px] mx-auto select-none">
      ...
      <!-- Fila de Unidades Tipográficas Puras (Estilo Papelería de Lujo) -->
      <div class="frosted-glass-card w-full py-4 px-2 sm:px-6 text-center">
        <div class="flex items-center justify-around w-full">
          
          <!-- Días -->
          <div class="flex-1 flex flex-col items-center">
            <span id="days" class="font-display-lg text-4xl sm:text-5xl font-light tabular-nums leading-none tracking-tight text-deep-onyx" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9.5px] sm:text-[10px] uppercase tracking-[0.3em] mt-2.5 font-medium text-antique-gold">Días</span>
          </div>

          <!-- Divisor Vertical Fino -->
          <div class="w-px h-10 bg-antique-gold/40 flex-shrink-0"></div>

          <!-- Horas -->
          <div class="flex-1 flex flex-col items-center">
            <span id="hours" class="font-display-lg text-4xl sm:text-5xl font-light tabular-nums leading-none tracking-tight text-deep-onyx" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9.5px] sm:text-[10px] uppercase tracking-[0.3em] mt-2.5 font-medium text-antique-gold">Horas</span>
          </div>
          ...
          <!-- Minutos -->
          <div class="flex-1 flex flex-col items-center">
            <span id="minutes" class="font-display-lg text-4xl sm:text-5xl font-light tabular-nums leading-none tracking-tight text-deep-onyx" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9.5px] sm:text-[10px] uppercase tracking-[0.3em] mt-2.5 font-medium text-antique-gold">Minutos</span>
          </div>
