      ...
      <div class="pergamino-container text-deep-onyx" id="pergaminoCard">
        ...
        <form id="rsvpForm" novalidate>
          ...
          <div class="form-group-clean" id="campo-dietas-container">
            <label for="alergias">Mensaje o Dieta Especial (Opcional)</label>
            <input type="text" id="alergias" name="alergias" placeholder="Ej: Vegetariano, felicitaciones...">
          </div>
...
(function initRsvpPergamino() {
  ...
  if (guestParam && guestParam.trim()) {
    ...
    if (contenedorSaludo) {
      contenedorSaludo.innerHTML = '<div class="mensaje-personalizado">' +
        '¡Qué alegría tenerte aquí, <strong class="text-deep-onyx">' + nombreDecodificado + '</strong>! Tus <strong>' + ticketsParam + (ticketsParam === 1 ? ' pase' : ' pases') + '</strong> ya están reservados' + mesaLabelTxt + '.' +
        '</div>';
    }
  ...
  if (rsvpForm) {
    rsvpForm.addEventListener('submit', (e) => {
      ...
      const allergies = inputAlergias ? inputAlergias.value.trim() : '';
