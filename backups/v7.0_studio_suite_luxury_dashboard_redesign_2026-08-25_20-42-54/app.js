...
function setupVipPassGenerator() {
  ...
  btnGen.addEventListener('click', () => {
    ...
    if (!guest) {
      showToast('Ingresa el nombre del invitado');
      inputGuest.focus();
      return;
    }
    ...
    showToast('Enlace VIP generado con éxito');
  });
  ...
  btnCopy.addEventListener('click', async () => {
    ...
    try {
      ...
      showToast('Mensaje y enlace copiados');
    } catch(err) {
  ...
  btnPrev.addEventListener('click', () => {
    ...
    showToast(`Previsualizando pase de: ${guest}`);
  });
}
...
function setupInputListeners() {
  ...
  if (btnSilk) {
    btnSilk.addEventListener('click', () => {
      ...
      showToast('Preset Seda Marfil aplicado');
    });
  }
