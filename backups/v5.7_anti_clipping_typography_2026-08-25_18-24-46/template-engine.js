...
<div class="flex flex-col w-full overflow-hidden relative">
  ...
  <section id="hero" class="relative min-h-[68vh] sm:min-h-[72vh] flex flex-col items-center justify-center px-margin-mobile text-center pt-10 pb-6" style="overflow: visible;">
    ...
    <div class="relative z-10 flex flex-col items-center gap-4 max-w-lg mx-auto gsap-scale-up w-full mt-2">
      ...
      <div class="flex flex-col items-center my-0.5 gsap-title overflow-visible">
        <h1 class="font-script text-5xl sm:text-7xl md:text-8xl font-normal overflow-visible ${titleEffectClass}" id="heroBrideName" style="font-family: var(--font-script);">
          ${brideDisplayName}
        </h1>
        <span class="font-script text-3xl sm:text-4xl md:text-5xl text-white/95 my-0 font-normal leading-normal drop-shadow-[0_2px_6px_rgba(0,0,0,0.85)] select-none overflow-visible" id="heroNameConnector" style="font-family: var(--font-script);">
          ${nameConnector}
        </span>
        <h1 class="font-script text-5xl sm:text-7xl md:text-8xl font-normal overflow-visible ${titleEffectClass}" id="heroGroomName" style="font-family: var(--font-script);">
          ${groomDisplayName}
        </h1>
      </div>` : `
      <h1 id="heroName" class="font-script text-6xl sm:text-8xl md:text-9xl font-normal my-2 gsap-title overflow-visible ${titleEffectClass}" style="font-family: var(--font-script);">
        ${brideDisplayName}
      </h1>`}
  ...
  <section id="itinerario" class="py-20 px-margin-mobile text-center max-w-2xl mx-auto relative overflow-hidden ${itinerarySteps.length ? '' : 'hidden'}">
    ...
    <div class="relative z-10 w-full">
      <div class="mb-14 gsap-fade-up overflow-visible">
        <h2 class="font-script text-5xl sm:text-6xl md:text-7xl font-normal mb-2 overflow-visible ${titleEffectClass}">Programa</h2>
  ...
  <section id="rsvp" class="py-24 px-margin-mobile bg-emerald-dark text-center relative overflow-hidden border-t border-antique-gold/30">
    ...
    <div class="relative z-10 max-w-md mx-auto gsap-scale-up overflow-visible">
      <h2 class="font-script text-4xl sm:text-5xl md:text-6xl mb-3 font-normal gsap-title overflow-visible ${titleEffectClass}">Confirma tu Asistencia</h2>
...
<footer class="py-16 px-margin-mobile text-center bg-emerald-deep border-t border-antique-gold/30">
  <p class="font-script text-4xl sm:text-5xl font-normal mb-2 gsap-fade-up overflow-visible ${titleEffectClass}">Con amor,</p>
