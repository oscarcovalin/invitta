...
<style>
  ...
  /* Efectos para Títulos: Degradado Metálico Foil vs Color Sólido */
  ...
  /* Glassmorphism Frosted Glass Box con Estilos Variables */
  .frosted-glass-card {
    background: var(--countdown-bg);
    color: var(--countdown-text);
    backdrop-filter: blur(20px);
    -webkit-backdrop-filter: blur(20px);
    border: 1px solid rgba(165, 110, 14, 0.28);
    box-shadow: 0 16px 40px -12px rgba(0, 0, 0, 0.18), inset 0 1px 1px rgba(255, 255, 255, 0.15);
  }
  ...
  .frosted-glass-pill {
    ...
    border: 1px solid rgba(165, 110, 14, 0.25);
...
<div class="flex flex-col w-full overflow-hidden relative">
  ...
  <section id="hero" class="relative min-h-[68vh] sm:min-h-[72vh] flex flex-col items-center justify-center px-margin-mobile text-center pt-10 pb-6" style="overflow: visible;">
    ...
    <div class="relative z-10 flex flex-col items-center gap-4 max-w-lg mx-auto gsap-scale-up w-full mt-2">
      ...
      <div class="flex flex-col items-center my-0.5 gsap-title">
        <h1 class="font-script text-6xl sm:text-7xl md:text-8xl leading-tight font-normal ${titleEffectClass}" id="heroBrideName" style="font-family: var(--font-script);">
          ${brideDisplayName}
        </h1>
        <span class="font-script text-3xl sm:text-4xl md:text-5xl text-white/95 my-[-4px] font-normal leading-none drop-shadow-[0_2px_6px_rgba(0,0,0,0.85)]" id="heroNameConnector" style="font-family: var(--font-script);">
          ${nameConnector}
        </span>
        <h1 class="font-script text-6xl sm:text-7xl md:text-8xl leading-tight font-normal ${titleEffectClass}" id="heroGroomName" style="font-family: var(--font-script);">
          ${groomDisplayName}
        </h1>
      </div>` : `
      <h1 id="heroName" class="font-script text-7xl sm:text-8xl md:text-9xl leading-tight font-normal my-2 gsap-title ${titleEffectClass}" style="font-family: var(--font-script);">
        ${brideDisplayName}
      </h1>`}
  ...
  <section id="countdownSection" class="${countdownPaddingTop} pb-20 px-margin-mobile text-center relative max-w-lg mx-auto gsap-fade-up">
    ...
    <!-- Divisor Delicado Editorial -->
    <div class="w-16 h-px bg-gradient-to-r from-transparent via-antique-gold/40 to-transparent mx-auto my-6"></div>

    <!-- CÁPSULA DE CRISTAL TRANSLÚCIDO FROSTED GLASS -->
    <div id="countdownWrapper" class="flex flex-col items-center w-full max-w-[360px] sm:max-w-[400px] mx-auto mt-2">
      
      <!-- Tarjeta de Cristal con Números Clásicos -->
      <div class="frosted-glass-card w-full rounded-3xl px-6 py-6 sm:px-8 sm:py-7 text-center">
        <div class="grid grid-cols-3 gap-3 items-center justify-between">
          
          <!-- Días -->
          <div class="flex flex-col items-center">
            <span id="days" class="font-display-lg text-3xl sm:text-4xl md:text-5xl font-light tabular-nums leading-none tracking-tight drop-shadow-md" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9.5px] sm:text-[10px] uppercase tracking-[0.25em] mt-2.5 font-medium opacity-90" style="color: var(--countdown-text);">Días</span>
          </div>

          <!-- Horas -->
          <div class="flex flex-col items-center border-x border-antique-gold/30 px-2 sm:px-4">
            <span id="hours" class="font-display-lg text-3xl sm:text-4xl md:text-5xl font-light tabular-nums leading-none tracking-tight drop-shadow-md" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9.5px] sm:text-[10px] uppercase tracking-[0.25em] mt-2.5 font-medium opacity-90" style="color: var(--countdown-text);">Horas</span>
          </div>

          <!-- Minutos -->
          <div class="flex flex-col items-center">
            <span id="minutes" class="font-display-lg text-3xl sm:text-4xl md:text-5xl font-light tabular-nums leading-none tracking-tight drop-shadow-md" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9.5px] sm:text-[10px] uppercase tracking-[0.25em] mt-2.5 font-medium opacity-90" style="color: var(--countdown-text);">Minutos</span>
          </div>

        </div>
      </div>

      <!-- Pastilla de Cristal con Frase Emotiva -->
      <div id="countdownPhraseWrap" class="frosted-glass-pill w-full rounded-full py-2.5 px-5 mt-4 text-center ${(config.countdownPhrase || isWedding) ? '' : 'hidden'}">
        <p id="countdownPhrase" class="font-label-caps text-[9px] sm:text-[10px] tracking-[0.25em] uppercase font-semibold" style="color: var(--countdown-text);">
          ${config.countdownPhrase || (isWedding ? 'Para casarme con el amor de mi vida' : 'Para mi gran día')}
        </p>
      </div>

      <!-- Botones de Calendario Coherentes con Espaciado -->
      <div class="flex flex-wrap justify-center items-center gap-3.5 mt-8">
        <a id="btnGoogleCalendar" href="#" target="_blank" rel="noopener noreferrer" class="btn-luxury-primary text-xs px-5 py-2.5">
          <span class="material-symbols-outlined text-[16px]">calendar_add_on</span>
          Google Calendar
        </a>
        <button type="button" id="btnCalendar" class="btn-luxury-secondary text-xs px-5 py-2.5">
  ...
  <section id="itinerario" class="py-20 px-margin-mobile text-center max-w-2xl mx-auto relative overflow-hidden ${itinerarySteps.length ? '' : 'hidden'}">
    ...
    <div class="relative z-10 w-full">
      <div class="mb-14 gsap-fade-up">
        <h2 class="font-script text-6xl sm:text-7xl font-normal mb-2 ${titleEffectClass}">Programa</h2>
  ...
  <section id="rsvp" class="py-24 px-margin-mobile bg-emerald-dark text-center relative overflow-hidden border-t border-antique-gold/30">
    ...
    <div class="relative z-10 max-w-md mx-auto gsap-scale-up">
      <h2 class="font-script text-5xl sm:text-6xl mb-3 font-normal gsap-title ${titleEffectClass}">Confirma tu Asistencia</h2>
...
<footer class="py-16 px-margin-mobile text-center bg-emerald-deep border-t border-antique-gold/30">
  <p class="font-script text-4xl font-normal mb-2 gsap-fade-up ${titleEffectClass}">Con amor,</p>
