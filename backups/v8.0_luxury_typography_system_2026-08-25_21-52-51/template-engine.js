...
<style>
  ...
  /* Escala Tipográfica Exacta de Alta Gama */
  .hero-name-scaled {
    font-family: var(--font-display) !important;
    font-size: clamp(44px, calc(3.25rem * var(--scale-hero, 1.0)), 56px) !important;
  ...
  .hero-solo-name-scaled {
    font-family: var(--font-display) !important;
    font-size: clamp(44px, calc(3.5rem * var(--scale-hero, 1.0)), 56px) !important;
    font-weight: 300 !important;
    line-height: 1.15 !important;
    letter-spacing: 0.02em !important;
  }
  .hero-connector-scaled {
    font-family: var(--font-script) !important;
    font-size: clamp(32px, calc(2.25rem * var(--scale-hero, 1.0)), 40px) !important;
    line-height: 1.1 !important;
    font-weight: 400 !important;
  }
  .heading-script-scaled {
    font-family: var(--font-display) !important;
    font-size: clamp(28px, calc(1.85rem * var(--scale-headings, 1.0)), 34px) !important;
    line-height: 1.25 !important;
    font-weight: 400 !important;
  }
  .heading-display-scaled {
    font-family: var(--font-display) !important;
    font-size: clamp(26px, calc(1.75rem * var(--scale-headings, 1.0)), 32px) !important;
    line-height: 1.25 !important;
    font-weight: 400 !important;
  }
  .body-scaled {
...
<div class="flex flex-col w-full overflow-hidden relative">
  ...
  <section id="hero" class="relative ${hasHeroPhoto ? 'pt-0 pb-12' : 'min-h-[68vh] sm:min-h-[72vh] flex flex-col items-center justify-center pt-10 pb-6 px-margin-mobile'} text-center" style="overflow: visible;">
    ...
    <!-- ╚══════════════════════════════════════════════════════════════╝ -->
    <div class="relative z-10 flex flex-col items-center gap-3 max-w-lg mx-auto gsap-fade-up w-full px-margin-mobile">
      
      <!-- VIP Guest Banner -->
      <div id="vipBanner" class="hidden flex-col items-center gap-0.5 px-6 py-2 bg-white/85 backdrop-blur-md rounded-full border border-antique-gold/40 shadow-sm mb-1">
      ...
      <p id="heroEyebrow" class="font-label-caps text-[11px] sm:text-[12px] text-antique-gold tracking-[0.25em] uppercase font-medium gsap-eyebrow">
        ${config.eyebrow || (isWedding ? 'Nuestra Boda' : 'Mis XV Años')}
      </p>

      <!-- Nombres con Serif (Cormorant Garamond 44-56px Regular/Light Nunca Bold) -->
      ${isWedding && groomDisplayName ? `
      <div class="flex flex-col items-center my-0.5 gsap-title overflow-visible">
        <h1 class="font-display-lg font-light overflow-visible hero-name-scaled ${titleEffectClass}" id="heroBrideName" style="font-family: var(--font-display);">
          ${brideDisplayName}
        </h1>
        <span class="font-script text-antique-gold my-1 font-normal leading-none select-none overflow-visible hero-connector-scaled" id="heroNameConnector" style="font-family: var(--font-script);">
          ${nameConnector}
        </span>
        <h1 class="font-display-lg font-light overflow-visible hero-name-scaled ${titleEffectClass}" id="heroGroomName" style="font-family: var(--font-display);">
          ${groomDisplayName}
        </h1>
      </div>` : `
      <h1 id="heroName" class="font-display-lg font-light my-2 gsap-title overflow-visible hero-solo-name-scaled ${titleEffectClass}" style="font-family: var(--font-display);">
        ${brideDisplayName}
      </h1>`}

      <!-- Frase / Cita de Bienvenida -->
      <div id="welcomeQuoteWrap" class="mt-2 max-w-[90%] mx-auto ${config.quote ? '' : 'hidden'}">
        <p id="welcomeQuote" class="font-display-lg text-xl sm:text-2xl md:text-3xl italic leading-relaxed text-deep-onyx/90 font-light">
          &ldquo;${config.quote || ''}&rdquo;
        </p>
      </div>

      <!-- Mensaje de Bienvenida (Sans 13-16px Regular Sin tracking extra) -->
      <div id="welcomeMessageWrap" class="max-w-[460px] mx-auto mt-2 ${config.welcomeMessage ? '' : 'hidden'}">
        <p id="welcomeMessage" class="font-body-lg text-[14px] sm:text-[15px] text-deep-onyx/85 leading-relaxed font-normal tracking-normal">
    ...
    <div class="relative z-10 flex flex-col items-center gap-3 max-w-lg mx-auto gsap-scale-up w-full mt-2">
      
      <!-- VIP Guest Banner -->
      <div id="vipBanner" class="hidden flex-col items-center gap-0.5 px-6 py-2 bg-black/60 backdrop-blur-md rounded-full border border-white/30 shadow-sm mb-1">
        <span class="font-label-caps text-[10px] uppercase tracking-[0.25em] text-antique-gold font-medium">Invitación Especial Para</span>
      ...
      <!-- Frase / Cita de Bienvenida -->
      <div id="welcomeQuoteWrap" class="mt-2 max-w-[90%] mx-auto ${config.quote ? '' : 'hidden'}">
        <p id="welcomeQuote" class="font-display-lg text-xl sm:text-2xl md:text-3xl italic leading-relaxed text-[#f7f6ec] font-light">
          &ldquo;${config.quote || ''}&rdquo;
        </p>
      </div>
      ...
      <div id="welcomeMessageWrap" class="max-w-[460px] mx-auto mt-2 ${config.welcomeMessage ? '' : 'hidden'}">
        <p id="welcomeMessage" class="font-body-lg text-[14px] sm:text-[15px] text-white/95 leading-relaxed font-normal tracking-normal">
          ${config.welcomeMessage || ''}
        </p>
      </div>
  ...
  <section id="storySection" class="py-10 px-margin-mobile text-center max-w-xl mx-auto relative overflow-visible ${hasStory ? '' : 'hidden'}">
    <div class="max-w-md mx-auto gsap-fade-up relative z-10">
      <p class="font-label-caps text-xs text-antique-gold tracking-[0.3em] mb-2" id="storySubtitle">${(config.story && config.story.subtitle) || ''}</p>
  ...
  <section id="countdownSection" class="${countdownPaddingTop} pb-20 px-margin-mobile text-center relative max-w-lg mx-auto gsap-fade-up overflow-visible ${isCountdownEnabled ? '' : 'hidden'}">
    ...
    <div id="heroDateBlock" class="w-full max-w-[380px] mx-auto mt-4 sm:mt-6 mb-6 py-1 gsap-fade-up select-none">
      ...
      <p id="heroDateMonth" class="font-label-caps text-[11px] sm:text-[12px] tracking-[0.25em] uppercase font-medium text-antique-gold mb-3 text-center">
      ...
      <div class="flex items-center justify-center gap-0 w-full">
        ...
        <div class="flex-1 flex justify-end pr-4 sm:pr-5">
          <p id="heroDateWeekday" class="font-label-caps text-[11px] sm:text-[12px] tracking-[0.25em] uppercase font-medium text-deep-onyx/75 text-right leading-tight">
        ...
        <!-- Centro: Número del Día (Serif 44–56px Light como elemento gráfico) -->
        <div class="px-5 sm:px-6 flex-shrink-0">
          <span id="heroDateDay" class="font-display-lg text-[48px] sm:text-[56px] font-light leading-none tracking-tight text-deep-onyx tabular-nums">
            ${dateDayNumber || '20'}
          </span>
        </div>
        ...
        <div class="flex-1 flex justify-start pl-4 sm:pl-5">
          <p id="heroDateTime" class="font-label-caps text-[11px] sm:text-[12px] tracking-[0.25em] uppercase font-medium text-deep-onyx/75 text-left leading-tight">
    ...
    <div id="countdownWrapper" class="flex flex-col items-center w-full max-w-[420px] mx-auto select-none">
      ...
      <div class="frosted-glass-card w-full py-4 px-1 sm:px-4 text-center">
        <div class="flex items-center justify-around w-full">
          ...
          <div class="flex-1 flex flex-col items-center">
            <span id="days" class="font-display-lg text-2xl sm:text-3xl font-light tabular-nums leading-none tracking-tight text-deep-onyx" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9px] uppercase tracking-[0.25em] mt-2 font-medium text-antique-gold">Días</span>
          </div>
          ...
          <!-- Horas -->
          <div class="flex-1 flex flex-col items-center">
            <span id="hours" class="font-display-lg text-2xl sm:text-3xl font-light tabular-nums leading-none tracking-tight text-deep-onyx" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9px] uppercase tracking-[0.25em] mt-2 font-medium text-antique-gold">Horas</span>
          </div>
          ...
          <!-- Minutos -->
          <div class="flex-1 flex flex-col items-center">
            <span id="minutes" class="font-display-lg text-2xl sm:text-3xl font-light tabular-nums leading-none tracking-tight text-deep-onyx" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9px] uppercase tracking-[0.25em] mt-2 font-medium text-antique-gold">Minutos</span>
          </div>
          ...
          <!-- Segundos -->
          <div class="flex-1 flex flex-col items-center">
            <span id="seconds" class="font-display-lg text-2xl sm:text-3xl font-light tabular-nums leading-none tracking-tight text-deep-onyx" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9px] uppercase tracking-[0.25em] mt-2 font-medium text-antique-gold">Segundos</span>
          </div>
      ...
      <div class="flex flex-wrap justify-center items-center gap-3 mt-7">
        <a id="btnGoogleCalendar" href="#" target="_blank" rel="noopener noreferrer" class="btn-luxury-secondary text-[11px] px-5 py-2 uppercase tracking-[0.25em] font-medium">
          <span class="material-symbols-outlined text-[15px]">calendar_add_on</span>
          Google Calendar
        </a>
        <button type="button" id="btnCalendar" class="btn-luxury-secondary text-[11px] px-5 py-2 uppercase tracking-[0.25em] font-medium">
  ...
  <section id="details" class="${detailsPaddingTop} pb-20 px-margin-mobile text-center max-w-3xl mx-auto relative overflow-hidden ${isLocationsEnabled ? '' : 'hidden'}">
    ...
    <div class="space-y-12 max-w-lg mx-auto gsap-stagger-container">
      ...
      <div id="ceremonyCard" class="relative bg-white/50 backdrop-blur-xl p-8 sm:p-10 rounded-2xl shadow-[0_8px_30px_rgba(165,110,14,0.08)] border border-antique-gold/50 gsap-stagger-item ${(config.ceremony && (config.ceremony.venue || config.ceremony.address)) ? '' : 'hidden'}">
        ...
        <h3 class="font-display-lg text-[20px] sm:text-[22px] font-normal text-deep-onyx mb-2 mt-4 gsap-title tracking-wide">Ceremonia Religiosa</h3>
        <p class="font-label-caps text-[11px] sm:text-[12px] text-antique-gold mb-3 tracking-[0.25em] uppercase font-medium">${(config.ceremony && config.ceremony.time) || ''}</p>
        <p class="font-body-lg text-deep-onyx font-medium mb-1 text-[15px]">${(config.ceremony && config.ceremony.venue) || ''}</p>
        <p class="font-body-lg text-[14px] text-tertiary mb-6 leading-relaxed font-normal">${(config.ceremony && config.ceremony.address) || ''}</p>
        
        <div class="flex flex-wrap justify-center items-center gap-3">
          <a id="ceremonyMap" class="btn-luxury-primary text-[11px] uppercase tracking-[0.25em] font-medium ${(config.ceremony && config.ceremony.mapsUrl) ? '' : 'hidden'}" href="${(config.ceremony && config.ceremony.mapsUrl) || '#'}" target="_blank" rel="noopener noreferrer">
            <span class="material-symbols-outlined text-[15px]">map</span>
            Google Maps
          </a>
          <a id="ceremonyWaze" class="btn-luxury-secondary text-[11px] uppercase tracking-[0.25em] font-medium ${(config.ceremony && config.ceremony.wazeUrl) ? '' : 'hidden'}" href="${(config.ceremony && config.ceremony.wazeUrl) || '#'}" target="_blank" rel="noopener noreferrer">
      ...
      <div id="receptionCard" class="relative bg-white/50 backdrop-blur-xl p-8 sm:p-10 rounded-2xl shadow-[0_8px_30px_rgba(165,110,14,0.08)] border border-antique-gold/50 gsap-stagger-item ${(config.reception && (config.reception.venue || config.reception.address)) ? '' : 'hidden'}">
        ...
        <h3 class="font-display-lg text-[20px] sm:text-[22px] font-normal text-deep-onyx mb-2 mt-4 gsap-title tracking-wide">Recepción</h3>
        <p class="font-label-caps text-[11px] sm:text-[12px] text-antique-gold mb-3 tracking-[0.25em] uppercase font-medium">${(config.reception && config.reception.time) || ''}</p>
        <p class="font-body-lg text-deep-onyx font-medium mb-1 text-[15px]">${(config.reception && config.reception.venue) || ''}</p>
        <p class="font-body-lg text-[14px] text-tertiary mb-6 leading-relaxed font-normal">${(config.reception && config.reception.address) || ''}</p>

        <div class="flex flex-wrap justify-center items-center gap-3">
          <a id="receptionMap" class="btn-luxury-primary text-[11px] uppercase tracking-[0.25em] font-medium ${(config.reception && config.reception.mapsUrl) ? '' : 'hidden'}" href="${(config.reception && config.reception.mapsUrl) || '#'}" target="_blank" rel="noopener noreferrer">
            <span class="material-symbols-outlined text-[15px]">map</span>
            Google Maps
          </a>
          <a id="receptionWaze" class="btn-luxury-secondary text-[11px] uppercase tracking-[0.25em] font-medium ${(config.reception && config.reception.wazeUrl) ? '' : 'hidden'}" href="${(config.reception && config.reception.wazeUrl) || '#'}" target="_blank" rel="noopener noreferrer">
            <span class="material-symbols-outlined text-[15px]">navigation</span>
            Waze
          </a>
        </div>
  ...
  <section id="dresscode" class="py-20 px-margin-mobile bg-emerald-deep text-center border-y border-antique-gold/30 relative overflow-hidden ${isDressCodeEnabled ? '' : 'hidden'}">
    ...
    <div class="max-w-xl mx-auto relative z-10">
      <span class="material-symbols-outlined text-antique-gold text-[38px] mb-4 font-light gsap-fade-up">checkroom</span>
      ...
      <p id="dressDesc" class="font-body-lg text-[#f7f6ec]/85 mb-8 max-w-sm mx-auto leading-relaxed text-[14px] sm:text-[15px] font-normal tracking-normal gsap-fade-up">${(config.dressCode && config.dressCode.description) || ''}</p>
      ...
      <p class="font-body-lg text-xs text-[#f7f6ec]/60 italic mt-6 ${(config.dressCode && config.dressCode.reservedColorsNote) ? '' : 'hidden'}">
  ...
  <section id="giftregistry" class="py-20 px-margin-mobile text-center max-w-xl mx-auto relative overflow-hidden ${isGiftRegistryEnabled ? '' : 'hidden'}">
    ...
    <div class="relative z-10 w-full">
      ...
      <p id="giftIntro" class="font-body-lg text-tertiary mb-8 max-w-md mx-auto leading-relaxed text-[14px] sm:text-[15px] font-normal tracking-normal gsap-fade-up">
      ...
      <div class="flex flex-col gap-4 max-w-sm mx-auto gsap-stagger-container mb-8">
        ${((config.giftRegistry && config.giftRegistry.stores) || []).map(store => `
          <a class="bg-white/60 backdrop-blur-sm border border-antique-gold/40 p-5 flex items-center justify-between shadow-sm hover:bg-white/90 hover:shadow-md transition-all gsap-stagger-item rounded-2xl" href="${store.url || '#'}" target="_blank" rel="noopener noreferrer">
            ...
            <span class="flex items-center gap-1 font-body-lg text-sm text-antique-gold font-normal">
      ...
      <div id="bankInfoCard" class="bg-white/70 backdrop-blur-sm border border-antique-gold/50 p-6 rounded-2xl max-w-sm mx-auto text-left shadow-sm ${(config.giftRegistry && config.giftRegistry.bank && config.giftRegistry.bank.clabe) ? '' : 'hidden'}">
        ...
        <p id="giftBankHolder" class="font-body-lg text-xs text-tertiary mb-3 font-normal">${(config.giftRegistry && config.giftRegistry.bank && config.giftRegistry.bank.holder) ? `Titular: ${config.giftRegistry.bank.holder}` : ''}</p>
        ...
        <div class="flex items-center justify-between gap-2 p-2.5 bg-champagne-cream rounded-full border border-antique-gold/30 px-4">
          ...
          <button type="button" id="btnCopyClabe" class="btn-luxury-primary text-[11px] px-3.5 py-1 uppercase tracking-[0.25em] font-medium">
            Copiar
          </button>
        </div>
      </div>

      <p id="giftEnvelopeNote" class="font-body-lg text-xs text-tertiary/80 italic mt-6 font-normal ${(config.giftRegistry && config.giftRegistry.envelopeNote) ? '' : 'hidden'}">
  ...
  <!-- ==================== 8.1 ÁLBUM COLABORATIVO ==================== -->
  <section id="albumColaborativo" class="py-16 px-margin-mobile text-center max-w-xl mx-auto relative overflow-hidden ${isSharedAlbumEnabled ? '' : 'hidden'}">
    ${(() => {
    ...
    <div class="bg-white/60 backdrop-blur-xl border border-antique-gold/40 p-8 sm:p-10 rounded-2xl shadow-[0_8px_30px_rgba(165,110,14,0.08)] relative z-10 overflow-hidden gsap-scale-up">
      ...
      <p class="font-body-lg text-[14px] sm:text-[15px] text-tertiary leading-relaxed mb-6 max-w-md mx-auto font-normal tracking-normal" id="albumDescription">
      ...
      <div class="bg-champagne-cream/90 border border-antique-gold/50 rounded-2xl p-4 sm:p-5 max-w-xs mx-auto mb-6 shadow-sm">
        ...
        <div class="flex items-center justify-between gap-2 mt-2 bg-white/80 rounded-full px-4 py-2 border border-antique-gold/30">
          ...
          <button type="button" id="btnCopyAlbumCode" class="btn-luxury-primary text-[11px] px-3 py-1 uppercase tracking-[0.25em] font-medium flex items-center gap-1">
  ...
  <section id="instagramSection" class="py-16 px-margin-mobile bg-emerald-deep text-center border-y border-antique-gold/30 relative overflow-hidden ${isInstagramEnabled ? '' : 'hidden'}">
    ...
    <div class="max-w-md mx-auto relative z-10">
      <span class="material-symbols-outlined text-antique-gold text-[38px] mb-3 font-light">photo_camera</span>
      ...
      <h3 id="instagramHashtag" class="font-body-lg text-2xl sm:text-3xl font-bold text-[#f7f6ec] mb-4 tracking-wide">${(config.instagram && config.instagram.hashtag) || ''}</h3>
      <p id="instagramText" class="font-body-lg text-[14px] text-[#f7f6ec]/85 mb-6 leading-relaxed font-normal tracking-normal">${(config.instagram && config.instagram.text) || 'Usa nuestro hashtag oficial en tus publicaciones e historias de Instagram.'}</p>
      
      <button type="button" id="btnCopyHashtag" class="btn-luxury-secondary-dark text-[11px] uppercase tracking-[0.25em] font-medium">
  ...
  <section id="rsvp" class="py-24 px-margin-mobile bg-emerald-dark text-center relative overflow-hidden border-t border-antique-gold/30 ${isRsvpEnabled ? '' : 'hidden'}">
    ...
    <div class="relative z-10 max-w-md mx-auto gsap-scale-up overflow-visible">
      <p class="font-label-caps text-[11px] sm:text-[12px] text-antique-gold tracking-[0.25em] uppercase font-medium mb-2">RSVP</p>
      <h2 class="font-display-lg mb-3 font-normal gsap-title overflow-visible heading-script-scaled text-[#f7f6ec] tracking-wide ${titleEffectClass}">Confirma tu Asistencia</h2>
      <p id="rsvpDeadline" class="font-body-lg text-[14px] sm:text-[15px] text-[#f7f6ec]/85 mb-8 gsap-fade-up font-normal tracking-normal">
...
<footer class="pt-16 pb-24 px-margin-mobile text-center bg-emerald-deep border-t border-antique-gold/30">
  <p class="font-script font-normal mb-1 gsap-fade-up overflow-visible text-2xl sm:text-3xl text-antique-gold">Con amor,</p>
  <p class="font-display-lg text-base sm:text-lg text-[#f7f6ec] tracking-[0.25em] uppercase font-light gsap-fade-up" id="footerNames">
    ${fullDisplayName}
  </p>
  <p class="font-body-lg text-xs text-[#f7f6ec]/50 mt-3 tracking-wider font-normal" id="footerCustomText">
    ${config.footerText || ''}
  </p>

  <!-- ==================== TARJETA DISCRETA DE CONTRATACIÓN (WHATSAPP) ==================== -->
  <div id="vendorCard" class="mt-12 pt-8 border-t border-antique-gold/20 max-w-sm mx-auto gsap-fade-up ${(vendorCard.enabled !== false) ? '' : 'hidden'}">
    <p class="font-label-caps text-[10px] sm:text-[10.5px] text-antique-gold tracking-[0.25em] mb-1.5 font-medium" id="vendorCardBadge">
      ${vendorCard.badge || '¿Deseas una invitación como esta?'}
    </p>
    <p class="font-body-lg text-xs text-[#f7f6ec]/75 leading-relaxed mb-4 max-w-xs mx-auto font-normal" id="vendorCardDesc">
      ${vendorCard.description || 'Diseño digital interactivo y exclusivo para Bodas, XV Años y Eventos Especiales.'}
    </p>
    <a id="btnVendorWhatsapp" href="${vendorWaLink}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-white/10 hover:bg-white/20 border border-antique-gold/40 hover:border-antique-gold text-antique-gold hover:text-[#f7f6ec] text-[11px] font-label-caps tracking-[0.25em] uppercase font-medium transition-all duration-300 shadow-sm">
    ...
    <span class="font-label-caps text-[9px] text-[#f7f6ec]/40 tracking-[0.25em] uppercase font-medium block mt-3" id="vendorCardAgency">
