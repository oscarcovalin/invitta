    ...
    <div class="relative z-10 max-w-lg mx-auto gsap-scale-up overflow-visible">
      ...
      <div class="pergamino-container text-deep-onyx" id="pergaminoCard">
        ...
        <div id="rsvpSuccess" class="hidden text-center py-3">
          ...
          <div class="pass-ticket-pergamino">
            ...
            <p class="font-body-lg text-xs text-tertiary mb-3" id="qrGuestTickets">
              Pase autorizado
            </p>

            <div id="qrContainer" class="flex justify-center my-3"></div>
...
// 6. RSVP Pergamino: Detección, Stepper, Folio Logístico y QR Pass
(function initRsvpPergamino() {
  ...
  if (urlGuest && urlGuest.trim()) {
    if (saludoCont) {
      saludoCont.innerHTML = \`
        <div class="mensaje-personalizado-pergamino">
          ¡Qué alegría tenerte aquí, <strong>\${urlGuest}</strong>! Tus <strong>\${urlTickets} \${urlTickets === 1 ? 'pase' : 'pases'}</strong> ya están reservados para nuestro gran día.
        </div>
      \`;
    }
    ...
    rsvpForm.addEventListener('submit', (e) => {
              ...
              if (db && Array.isArray(db.guests)) {
                ...
                if (found) {
                  if (found.tableId === 'tbl_imperial' || String(found.tableId).includes('imp') || found.court || found.vip) {
                    ...
                    if (mMatch) mesaCode = 'M' + mMatch[0].padStart(2, '0');
                  }
      ...
      setTimeout(() => {
        ...
        if (rsvpSuccess) {
          ...
          if (isAttending) {
            if (ticketsEl) ticketsEl.textContent = \`Pase autorizado para: \${confirmedTickets} persona(s)\`;
