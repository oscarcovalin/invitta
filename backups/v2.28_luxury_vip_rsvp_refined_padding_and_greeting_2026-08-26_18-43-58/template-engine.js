...
<div class="flex flex-col w-full overflow-hidden relative">
  ...
  <!-- ==================== 10. RSVP PERGAMINO (CONFIRMACIÓN & PASE DE HONOR) ==================== -->
  <section id="rsvp" class="pt-20 pb-36 px-margin-mobile bg-emerald-dark text-center relative overflow-hidden border-t border-antique-gold/30 ${isRsvpEnabled ? '' : 'hidden'}">
    ${(() => {
    ...
    <div class="relative z-10 max-w-lg mx-auto gsap-scale-up overflow-visible">
      
      <!-- Contenedor Pergamino de Lujo -->
      <div class="pergamino-container text-deep-onyx" id="pergaminoCard">
        
        <!-- Ribete / Adorno Superior -->
        ...
        <h2 class="font-display-lg text-[25px] sm:text-[29px] font-normal text-deep-onyx mb-1 tracking-wide uppercase">
          Confirmación de Asistencia
        </h2>
        <p class="font-display-lg italic text-[14.5px] sm:text-[16px] text-antique-gold mb-5 font-light" id="subEventoRsvp">
          ${fullDisplayName} · ${config.eventDateShort || config.eventDateLabel || ''}
        </p>

        <!-- Saludo Personalizado Dinámico -->
        <div id="contenedor-saludo-pergamino"></div>

        <!-- Formulario RSVP -->
        <form id="rsvpForm" class="flex flex-col gap-4 text-left" novalidate>
          
          <!-- Nombre (se oculta si viene por URL personalizada) -->
          <div id="campoNombrePergamino" class="flex flex-col gap-1.5">
            <label class="font-label-caps text-[11px] text-deep-onyx uppercase tracking-[0.2em] font-semibold">
              Nombre Completo
            </label>
            <input id="formGuestName" name="nombre" required class="w-full bg-[#FAF8F5] border border-antique-gold/40 rounded-xl px-4 py-2.5 font-body-lg text-deep-onyx focus:outline-none focus:border-antique-gold focus:ring-2 focus:ring-antique-gold/20 transition-all text-sm placeholder:text-neutral-400" placeholder="Escribe tu nombre y apellidos" type="text"/>
          </div>

          <!-- Teléfono / WhatsApp -->
          <div id="campoTelefonoPergamino" class="flex flex-col gap-1.5">
            <label class="font-label-caps text-[11px] text-deep-onyx uppercase tracking-[0.2em] font-semibold">
              Teléfono / WhatsApp
            </label>
            <input id="formGuestPhone" name="telefono" class="w-full bg-[#FAF8F5] border border-antique-gold/40 rounded-xl px-4 py-2.5 font-body-lg text-deep-onyx focus:outline-none focus:border-antique-gold focus:ring-2 focus:ring-antique-gold/20 transition-all text-sm placeholder:text-neutral-400" placeholder="Para enviar confirmación y recordatorios" type="tel"/>
          </div>
          ...
          <div class="flex flex-col gap-2 pt-1">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              <label class="flex items-center gap-2.5 cursor-pointer p-3 border border-antique-gold/40 rounded-xl bg-champagne-cream/60 hover:bg-champagne-cream transition-colors text-deep-onyx">
                <input class="accent-antique-gold w-4 h-4" name="rsvp" value="si" checked type="radio" id="radioAsistenciaSi"/>
                <span class="font-body-lg text-[13px] font-medium">¡Sí, ahí estaré!</span>
              </label>
              <label class="flex items-center gap-2.5 cursor-pointer p-3 border border-antique-gold/40 rounded-xl bg-champagne-cream/60 hover:bg-champagne-cream transition-colors text-deep-onyx">
                <input class="accent-antique-gold w-4 h-4" name="rsvp" value="no" type="radio" id="radioAsistenciaNo"/>
                <span class="font-body-lg text-[13px] font-medium">No podré asistir</span>
              </label>
            </div>
          </div>

          <!-- Selector de Pases (Stepper) -->
          <div id="rsvpTicketsRow" class="flex flex-col sm:flex-row items-center justify-between p-3.5 bg-champagne-cream/70 border border-antique-gold/40 rounded-xl mt-1 gap-2">
            <div class="text-center sm:text-left">
              <span class="font-label-caps text-[11px] text-deep-onyx uppercase tracking-[0.2em] block font-semibold">Pases a Confirmar</span>
              <span id="allowedTicketsHint" class="text-[11px] text-tertiary font-normal">Máximo 2 personas</span>
            </div>
            <div class="flex items-center gap-3">
              <button type="button" class="stepper__btn w-8 h-8 rounded-full border border-antique-gold bg-antique-gold text-white flex items-center justify-center font-bold text-base hover:opacity-90 active:scale-95 transition-all" data-step="-1">-</button>
              <span id="guestCount" class="font-display-lg text-lg text-deep-onyx font-semibold tabular-nums min-w-[20px] text-center">1</span>
              <button type="button" class="stepper__btn w-8 h-8 rounded-full border border-antique-gold bg-antique-gold text-white flex items-center justify-center font-bold text-base hover:opacity-90 active:scale-95 transition-all" data-step="1">+</button>
            </div>
          </div>

          <!-- Preferencias Dietarias y Alergias (Conexión Catering) -->
          <div id="rsvpDietaryBlock" class="flex flex-col gap-2 pt-2 border-t border-antique-gold/25 mt-1">
            <div class="flex items-center justify-between">
              <label class="font-label-caps text-[11px] text-deep-onyx uppercase tracking-[0.2em] font-semibold flex items-center gap-1">
                <span>🍽️</span> Preferencias Dietarias
              </label>
              <span class="text-[10px] text-antique-gold/90 font-medium">(Opcional)</span>
            </div>
            <div class="grid grid-cols-2 gap-2 text-xs">
              <label class="flex items-center gap-2 p-2 border border-antique-gold/30 rounded-lg bg-champagne-cream/40 cursor-pointer">
                <input type="checkbox" name="diet" value="Vegetariano/Vegano" class="accent-antique-gold">
                <span class="text-[11px] text-deep-onyx font-medium">Vegetariano / Vegano</span>
              </label>
              <label class="flex items-center gap-2 p-2 border border-antique-gold/30 rounded-lg bg-champagne-cream/40 cursor-pointer">
                <input type="checkbox" name="diet" value="Sin Gluten (Celíaco)" class="accent-antique-gold">
                <span class="text-[11px] text-deep-onyx font-medium">Sin Gluten / Celíaco</span>
              </label>
              <label class="flex items-center gap-2 p-2 border border-antique-gold/30 rounded-lg bg-champagne-cream/40 cursor-pointer">
                <input type="checkbox" name="diet" value="Menú Infantil" class="accent-antique-gold">
                <span class="text-[11px] text-deep-onyx font-medium">Menú Infantil</span>
              </label>
              <label class="flex items-center gap-2 p-2 border border-antique-gold/30 rounded-lg bg-champagne-cream/40 cursor-pointer">
                <input type="checkbox" name="diet" value="Sin Lácteos" class="accent-antique-gold">
                <span class="text-[11px] text-deep-onyx font-medium">Sin Lácteos</span>
              </label>
            </div>
            <input type="text" name="alergias" id="formGuestAllergies" placeholder="Alergias o notas para cocina (ej: nueces, mariscos...)" 
                   class="w-full bg-[#FAF8F5] border border-antique-gold/40 rounded-xl px-3.5 py-2 text-xs text-deep-onyx focus:outline-none focus:border-antique-gold placeholder:text-neutral-400">
          </div>

          <!-- Botón de Envío -->
          <button type="submit" id="rsvpSubmit" class="btn-luxury-primary w-full py-3.5 text-[11.5px] tracking-[0.25em] uppercase font-semibold shadow-[0_4px_20px_rgba(165,110,14,0.35)] mt-2 mb-4 cursor-pointer transition-all hover:scale-[1.01] active:scale-[0.99]">
            Enviar Confirmación en Pergamino
          </button>
        </form>

        <!-- Vista de Éxito / Pase Digital Pergamino de Alta Costura -->
        <div id="rsvpSuccess" class="hidden text-center py-3">
          <span class="text-4xl text-antique-gold block mb-2">📜</span>
          <h3 class="font-display-lg text-2xl font-normal text-deep-onyx uppercase tracking-wide">
            ¡Confirmación Registrada!
          </h3>
          <p class="font-display-lg text-sm text-tertiary mt-1" id="rsvpSuccessMsg">
            Tu respuesta ha sido registrada exitosamente en el sistema oficial.
          </p>

          <!-- Tarjeta del Pase Pergamino -->
          <div class="pass-ticket-pergamino" id="passTicketPergamino">
            <span class="font-label-caps text-[10px] uppercase tracking-[0.25em] text-antique-gold font-bold block mb-1">
              Pase Digital de Acceso Oficial
            </span>
            <h4 class="font-display-lg text-xl sm:text-2xl text-deep-onyx font-normal my-1" id="qrGuestName">
              Invitado de Honor
            </h4>
            ...
            <!-- Badge de Mesa Asignada -->
            <div id="badgePassTable" class="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-antique-gold/15 border border-antique-gold/40 text-deep-onyx font-bold text-xs mb-3 font-mono">
            ...
            <!-- Folio Logístico -->
            <div class="inline-block px-4 py-1.5 rounded-full bg-black/5 border border-antique-gold/40 mt-1">
              <p class="font-mono text-xs text-deep-onyx font-bold tracking-widest uppercase" id="qrFolio">
                M03-MARTINEZ-4P
              </p>
            </div>

            <!-- Dietas Resumidas en el Pase -->
            <div id="passDietarySummary" class="text-[10px] text-tertiary italic mt-2 hidden"></div>
          </div>

          <p class="font-body-lg text-[11.5px] text-tertiary/90 max-w-xs mx-auto mb-4 font-normal">
            Presenta este folio y código QR en la recepción para agilizar tu ingreso al salón.
          </p>
          ...
          <button type="button" id="btnResetRsvp" class="text-xs text-antique-gold hover:underline font-medium cursor-pointer">
            ↺ Modificar o registrar otra respuesta
          </button>
        </div>
...
(function initRsvpPergamino() {
  ...
  if (urlGuest && urlGuest.trim()) {
    ...
    if (saludoCont) {
      saludoCont.innerHTML = '<div class="mensaje-personalizado-pergamino shadow-sm border border-antique-gold/40 rounded-2xl bg-amber-500/10 p-4 mb-4 text-left">' +
        '<div class="flex items-center gap-2 mb-1.5 text-antique-gold font-bold">' +
          '<span class="text-xl">⚜️</span>' +
          '<strong class="font-display-lg text-xs uppercase tracking-wider text-deep-onyx">Pase de Honor Personalizado</strong>' +
        '</div>' +
    ...
    if (ticketsHint) ticketsHint.textContent = 'Máximo ' + urlTickets + ' persona' + (urlTickets === 1 ? '' : 's');
  } else {
    if (saludoCont) {
      saludoCont.innerHTML = '<div class="mensaje-personalizado-pergamino shadow-sm border border-antique-gold/30 rounded-2xl bg-champagne-cream/50 p-3.5 mb-3 text-left">' +
        '<div class="flex items-center gap-1.5 mb-1 text-antique-gold font-bold">' +
          '<span class="text-base">⚜️</span>' +
          '<strong class="font-display-lg text-[11px] uppercase tracking-wider text-deep-onyx">Registro de Asistencia</strong>' +
        '</div>' +
        '<p class="text-xs text-deep-onyx/85 leading-relaxed">' +
          'Ingresa tu nombre para generar tu pase digital de acceso y asignar tu mesa oficial.' +
        '</p>' +
      '</div>';
    }
  ...
  document.querySelectorAll('input[name="rsvp"]').forEach(r => {
    r.addEventListener('change', () => {
      if (r.value === 'no') {
        ...
        if (btnSubmit) btnSubmit.textContent = 'Enviar Aviso (No podré asistir)';
      } else {
        if (ticketsRow) ticketsRow.style.display = 'flex';
        if (dietaryBlock) dietaryBlock.style.display = 'flex';
        if (btnSubmit) btnSubmit.textContent = 'Enviar Confirmación en Pergamino';
      }
    });
  });
  ...
  if (btnReset) {
    btnReset.addEventListener('click', () => {
      ...
      if (btnSubmit) {
        ...
        btnSubmit.textContent = 'Enviar Confirmación en Pergamino';
      }
      if (urlGuest && inputNombre) inputNombre.value = urlGuest;
      if (ticketsRow) ticketsRow.style.display = 'flex';
      if (dietaryBlock) dietaryBlock.style.display = 'flex';
      guestCount = Math.min(urlTickets, Math.max(1, urlTickets));
      if (guestOut) guestOut.textContent = guestCount;
    });
  }
  ...
  if (rsvpForm) {
    rsvpForm.addEventListener('submit', (e) => {
      ...
      const selectedDiets = Array.from(rsvpForm.querySelectorAll('input[name="diet"]:checked')).map(cb => cb.value);
      const allergies = (data.get('alergias') || '').trim();
      let dietaryNotes = selectedDiets.join(', ');
      if (allergies) dietaryNotes += (dietaryNotes ? ' | ' : '') + 'Alergias: ' + allergies;
            ...
            if (rawDb) {
              ...
              if (db && Array.isArray(db.guests)) {
                ...
                if (found) {
                  ...
                  if (dietaryNotes) found.dietary = dietaryNotes;
      ...
      const triggerWhatsApp = () => {
        if (CONFIG.whatsappNumber && CONFIG.whatsappNumber.trim()) {
          ...
          if (isAttending) {
            ...
            lines.push('🔖 *Folio Logístico:* ' + folio);
            if (dietaryNotes) lines.push('🍽️ *Preferencias Dietarias:* ' + dietaryNotes);
          }
      ...
      // Auto-trigger WhatsApp on confirm if configured
      triggerWhatsApp();

      if (btnSubmit) {
        btnSubmit.disabled = true;
        btnSubmit.textContent = 'Generando Pase en Pergamino...';
      }
      ...
      setTimeout(() => {
        ...
        if (rsvpSuccess) {
          ...
          if (isAttending) {
            ...
            if (dietaryNotes && dietarySumEl) {
              dietarySumEl.textContent = '🍽️ Menú: ' + dietaryNotes;
