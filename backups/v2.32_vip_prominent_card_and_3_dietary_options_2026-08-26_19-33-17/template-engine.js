...
<style>
  ...
  .pergamino-container {
    ...
    max-width: 480px;
    margin: 0 auto;
    box-shadow: 0 10px 30px rgba(22, 60, 43, 0.12);
  ...
  .mensaje-personalizado-pergamino, .mensaje-personalizado {
    background-color: rgba(163, 128, 71, 0.1);
      ...
      <div class="pergamino-container text-deep-onyx" id="pergaminoCard">
        ...
        <form id="rsvpForm" novalidate>
          ...
          <div class="form-group-clean" id="campo-pases-container">
            ...
            <input type="number" id="pases" name="pases" min="1" value="1" required>
          </div>

          <div class="form-group-clean" id="campo-dietas-container">
            <label style="margin-bottom: 6px; display:block;">Dieta Especial / Menú (Opcional)</label>
            <div class="grid grid-cols-3 gap-2 mb-2">
              <label class="diet-option-btn flex flex-col items-center justify-center gap-1 p-2.5 rounded-lg border border-antique-gold/40 bg-antique-gold/5 cursor-pointer text-center select-none transition-all hover:bg-antique-gold/15" id="labelDietVegano">
                <input type="checkbox" name="dietaOption" value="Vegano" class="hidden diet-checkbox" id="checkDietVegano">
                <span class="text-base">🥦</span>
                <span class="text-[11px] font-medium text-deep-onyx">Vegano</span>
              </label>
              <label class="diet-option-btn flex flex-col items-center justify-center gap-1 p-2.5 rounded-lg border border-antique-gold/40 bg-antique-gold/5 cursor-pointer text-center select-none transition-all hover:bg-antique-gold/15" id="labelDietInfantil">
                <input type="checkbox" name="dietaOption" value="Menú Infantil" class="hidden diet-checkbox" id="checkDietInfantil">
                <span class="text-base">👶</span>
                <span class="text-[11px] font-medium text-deep-onyx">Infantil</span>
              </label>
              <label class="diet-option-btn flex flex-col items-center justify-center gap-1 p-2.5 rounded-lg border border-antique-gold/40 bg-antique-gold/5 cursor-pointer text-center select-none transition-all hover:bg-antique-gold/15" id="labelDietAlergias">
                <input type="checkbox" name="dietaOption" value="Alergias" class="hidden diet-checkbox" id="checkDietAlergias">
                <span class="text-base">⚠️</span>
                <span class="text-[11px] font-medium text-deep-onyx">Alergias</span>
              </label>
            </div>
            <input type="text" id="alergias" name="alergias" placeholder="Especifica alergias o mensaje adicional (opcional)..." class="text-xs">
          </div>
...
(function initRsvpPergamino() {
  ...
  if (guestParam && guestParam.trim()) {
    ...
    if (inputPases) {
      inputPases.value = ticketsParam;
      inputPases.max = ticketsParam;
    }
  } else {
    if (contenedorSaludo) {
    ...
    if (inputPases) inputPases.value = 1;
  }

  // Interactive Diet Toggle Buttons (Vegano, Infantil, Alergias)
  const dietButtons = [
    { labelId: 'labelDietVegano', checkId: 'checkDietVegano' },
    { labelId: 'labelDietInfantil', checkId: 'checkDietInfantil' },
    { labelId: 'labelDietAlergias', checkId: 'checkDietAlergias' }
  ];

  dietButtons.forEach(({ labelId, checkId }) => {
    ...
    if (labelEl && checkEl) {
      labelEl.addEventListener('click', () => {
        setTimeout(() => {
          if (checkEl.checked) {
            labelEl.classList.add('border-2', 'border-antique-gold', 'bg-antique-gold/25', 'font-bold', 'scale-105', 'shadow-sm');
            labelEl.classList.remove('bg-antique-gold/5');
          } else {
            labelEl.classList.remove('border-2', 'border-antique-gold', 'bg-antique-gold/25', 'font-bold', 'scale-105', 'shadow-sm');
            labelEl.classList.add('bg-antique-gold/5');
          }
        }, 10);
      });
    }
  ...
  if (rsvpForm) {
    rsvpForm.addEventListener('submit', (e) => {
      ...
      const selectedDiets = Array.from(document.querySelectorAll('.diet-checkbox:checked')).map(c => c.value);
      const extraNotes = inputAlergias ? inputAlergias.value.trim() : '';
      let allergies = selectedDiets.join(', ');
      if (extraNotes) {
        allergies += (allergies ? ' | ' : '') + extraNotes;
      }
