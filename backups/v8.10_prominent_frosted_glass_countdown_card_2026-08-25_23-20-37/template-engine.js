...
<style>
  ...
  /* Estilo Editorial de Alta Gama para el Contador (Frosted Glass Card de Alto Contraste) */
  .frosted-glass-card {
    background: var(--countdown-bg, rgba(255, 255, 255, 0.70));
    backdrop-filter: blur(16px);
    -webkit-backdrop-filter: blur(16px);
    color: var(--countdown-text, #222222);
    border: 1px solid rgba(165, 110, 14, 0.40);
    border-radius: 1.25rem;
    box-shadow: 0 8px 32px rgba(165, 110, 14, 0.08);
  }
...
<div class="flex flex-col w-full overflow-hidden relative">
  ...
  <section id="countdownSection" class="${countdownPaddingTop} pb-20 px-margin-mobile text-center relative max-w-lg mx-auto gsap-fade-up overflow-visible ${isCountdownEnabled ? '' : 'hidden'}">
    ...
    <div id="countdownWrapper" class="flex flex-col items-center w-full max-w-[420px] mx-auto select-none">
      ...
      <div class="frosted-glass-card w-full py-5 px-2 sm:px-5 text-center">
        <div class="flex items-center justify-around w-full">
          
          <!-- Días -->
          <div class="flex-1 flex flex-col items-center">
            <span id="days" class="font-display-lg text-[32px] sm:text-[38px] md:text-[42px] font-normal tabular-nums leading-none tracking-tight text-deep-onyx" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9.5px] sm:text-[10.5px] uppercase tracking-[0.25em] mt-2 font-medium text-antique-gold">Días</span>
          </div>

          <!-- Divisor Vertical Fino -->
          <div class="w-px h-11 sm:h-12 bg-antique-gold/40 flex-shrink-0"></div>

          <!-- Horas -->
          <div class="flex-1 flex flex-col items-center">
            <span id="hours" class="font-display-lg text-[32px] sm:text-[38px] md:text-[42px] font-normal tabular-nums leading-none tracking-tight text-deep-onyx" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9.5px] sm:text-[10.5px] uppercase tracking-[0.25em] mt-2 font-medium text-antique-gold">Horas</span>
          </div>
          ...
          <!-- Minutos -->
          <div class="flex-1 flex flex-col items-center">
            <span id="minutes" class="font-display-lg text-[32px] sm:text-[38px] md:text-[42px] font-normal tabular-nums leading-none tracking-tight text-deep-onyx" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9.5px] sm:text-[10.5px] uppercase tracking-[0.25em] mt-2 font-medium text-antique-gold">Minutos</span>
          </div>
          ...
          <!-- Segundos -->
          <div class="flex-1 flex flex-col items-center">
            <span id="seconds" class="font-display-lg text-[32px] sm:text-[38px] md:text-[42px] font-normal tabular-nums leading-none tracking-tight text-deep-onyx" style="color: var(--countdown-text);">00</span>
            <span class="font-label-caps text-[9.5px] sm:text-[10.5px] uppercase tracking-[0.25em] mt-2 font-medium text-antique-gold">Segundos</span>
          </div>
      ...
      <div id="ceremonyCard" class="relative bg-white/50 backdrop-blur-xl p-8 sm:p-10 rounded-2xl shadow-[0_8px_30px_rgba(165,110,14,0.08)] border border-antique-gold/50 gsap-stagger-item ${(config.ceremony && (config.ceremony.venue || config.ceremony.address)) ? '' : 'hidden'}">
        ...
        <div class="my-3 flex items-center justify-center ${(config.ceremony && config.ceremony.time) ? '' : 'hidden'}">
          <span class="inline-flex items-center gap-1.5 px-4 py-1 rounded-full bg-antique-gold/[0.09] border border-antique-gold/40 shadow-[0_2px_8px_rgba(165,110,14,0.06)]">
            <span class="material-symbols-outlined text-antique-gold text-[15px]">schedule</span>
