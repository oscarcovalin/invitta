...
const SEED_PHOTOS: AlbumPhoto[] = [
  {
    ...
    message: "¡La ceremonia estuvo hermosa! Muy orgullosos de ti, Ana Camila.",
  ...
  },
  {
    ...
    message: "¡Qué bonita fiesta! El vals me hizo llorar. ¡Felicidades! 🎉",
  ...
  },
  {
    ...
    message: "Brindando por tus quince años. ¡A disfrutar la noche!",
    ...
    <section id="collaborative-album" className="py-24 px-margin-mobile bg-paper relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-[#454841] text-xs uppercase tracking-widest text-sage">
            Comparte tus mejores momentos capturados durante mi evento
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-20">
          ...
          <motion.div
            ...
            transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
            className="lg:col-span-5 bg-[#211a18] text-[#f4efe9] p-8 md:p-10 border border-sage/15 flex flex-col justify-between relative shadow-2xl rounded-xs"
          >
            ...
            <div className="space-y-6 relative z-10 text-center lg:text-left">
              <span className="text-[10px] tracking-[0.3em] uppercase text-[#dfba6b] font-bold block">
                Escanea y Comparte
              </span>
              <h3 className="font-serif text-2xl md:text-3xl text-[#fffbf0] font-light leading-snug">
                Sube fotos en vivo desde tu celular
              </h3>
              <p className="text-[#cdc5bc] text-xs leading-relaxed font-sans font-light">
            ...
            <div className="my-8 flex justify-center items-center relative z-10">
              <div className="p-4 bg-white/95 rounded-sm shadow-xl border-4 border-champagne-gold/30 flex flex-col items-center gap-2 relative">
                ...
                <svg viewBox="0 0 100 100" className="w-40 h-40" fill="#2d2422">
                  {/* Position detection patterns (top-left, top-right, bottom-left) */}
                  <rect x="0" y="0" width="30" height="30" fill="#2d2422" rx="2" />
                  <rect x="5" y="5" width="20" height="20" fill="#fff" rx="1" />
                  <rect x="10" y="10" width="10" height="10" fill="#dfba6b" rx="1" />

                  <rect x="70" y="0" width="30" height="30" fill="#2d2422" rx="2" />
                  <rect x="75" y="5" width="20" height="20" fill="#fff" rx="1" />
                  <rect x="80" y="10" width="10" height="10" fill="#dfba6b" rx="1" />

                  <rect x="0" y="70" width="30" height="30" fill="#2d2422" rx="2" />
                  <rect x="5" y="75" width="20" height="20" fill="#fff" rx="1" />
                  <rect x="10" y="80" width="10" height="10" fill="#dfba6b" rx="1" />

                  {/* Randomized realistic QR patterns representing a custom URL */}
                  <rect x="40" y="0" width="10" height="10" fill="#dfba6b" />
                  <rect x="50" y="10" width="10" height="10" fill="#2d2422" />
                  <rect x="40" y="20" width="10" height="10" fill="#2d2422" />
                  <rect x="55" y="20" width="10" height="10" fill="#dfba6b" />

                  <rect x="0" y="40" width="10" height="10" fill="#dfba6b" />
                  <rect x="10" y="50" width="10" height="10" fill="#2d2422" />
                  <rect x="20" y="40" width="10" height="10" fill="#dfba6b" />

                  <rect x="70" y="40" width="10" height="10" fill="#dfba6b" />
                  <rect x="80" y="50" width="10" height="10" fill="#2d2422" />
                  <rect x="90" y="40" width="10" height="10" fill="#dfba6b" />
                  
                  <rect x="40" y="40" width="20" height="20" fill="#2d2422" rx="1" />
                  <rect x="45" y="45" width="10" height="10" fill="#fff" rx="0.5" />

                  <rect x="40" y="70" width="10" height="10" fill="#dfba6b" />
                  <rect x="50" y="80" width="10" height="10" fill="#2d2422" />
                  <rect x="40" y="90" width="10" height="10" fill="#2d2422" />
                  <rect x="55" y="90" width="10" height="10" fill="#dfba6b" />

                  <rect x="80" y="80" width="15" height="15" fill="#dfba6b" />
                  <rect x="85" y="85" width="5" height="5" fill="#2d2422" />
                </svg>

                {/* Micro emblem in the middle or bottom */}
                <span className="text-[8px] tracking-[0.1em] font-serif uppercase text-[#ab8478] font-bold">
                  Ana Camila • XV
                </span>
              </div>
            </div>
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-80px" }}
            transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
            className="lg:col-span-7 bg-[#FAF9F5] p-8 md:p-10 border border-outline-variant/35 flex flex-col justify-between shadow-xl relative rounded-xs"
          >
            ...
            <div className="absolute top-0 right-0 w-16 h-16 pointer-events-none opacity-30">
              <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full rotate-90">
                <path d="M0 0 C 30 10, 40 40, 10 100 Z" fill="#ab8478" opacity="0.2" />
                <path d="M0 0 Q 30 30 60 100" stroke="#dfba6b" strokeWidth="0.5" opacity="0.3" />
              </svg>
            </div>
            ...
            <form onSubmit={handleUploadSubmit} className="space-y-6 flex-grow flex flex-col justify-between">
              ...
              {!previewUrl ? (
                <div
                  ...
                  className={`mt-6 mb-6 flex flex-col items-center justify-center p-8 border-2 border-dashed rounded-xs cursor-pointer transition-all duration-300 min-h-[180px] ${
                    dragActive 
                      ...
                      : "border-sage/30 hover:border-sage hover:bg-stone-50"
                  }`}
                >
                  <input
                    ref={fileInputRef}
                ...
                <div className="mt-4 mb-4 grid grid-cols-1 sm:grid-cols-12 gap-6 items-center">
                  ...
                  <div className="sm:col-span-4 relative aspect-[4/3] sm:aspect-square w-full overflow-hidden border border-outline-variant rounded-xs bg-stone-100">
                    <img 
                      src={previewUrl} 
                  ...
                  <div className="sm:col-span-8 space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2 text-xs border border-outline-variant/60 focus:border-sage bg-white rounded-xs focus:outline-none text-ink font-light tracking-wide"
                        required
                        disabled={uploading}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="¡Felicidades Ana Camila!"
                        className="w-full px-4 py-2 text-xs border border-outline-variant/60 focus:border-sage bg-white rounded-xs focus:outline-none text-ink font-light tracking-wide"
                        disabled={uploading}
                      />
                    </div>
              ...
              <div className="pt-4 border-t border-sage/10 relative z-10">
                {uploading ? (
                  <div className="space-y-3">
                    ...
                    <div className="w-full h-1 bg-stone-200/60 overflow-hidden rounded-full">
                      <motion.div
                  ...
                  <button
                    ...
                    className={`w-full py-4 text-[11px] tracking-[0.25em] font-semibold uppercase rounded-xs transition-all duration-500 flex items-center justify-center gap-2 cursor-pointer ${
                      previewUrl
                        ? "bg-[#211a18] text-[#f4efe9] hover:bg-champagne-gold hover:text-ink shadow-lg"
                ...
                {photos.map((photo) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="bg-[#fafafa] border border-outline-variant/30 rounded-xs overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 group flex flex-col justify-between"
                    >
                      ...
                      <div className="p-5 flex flex-col justify-between flex-grow space-y-4">
                        ...
                        <div className="flex items-center justify-between pt-3 border-t border-stone-200/50">
                          ...
                          <button
                            ...
                            className="flex items-center gap-1.5 text-sage hover:text-[#b38577] transition-colors cursor-pointer select-none group/btn"
                          >
                            <Heart 
                              className={`w-4 h-4 transition-all duration-300 ${
                                isLiked 
                                  ? "fill-[#b38577] text-[#b38577] scale-110" 
                          ...
                          <a
                            href={photo.src}
                            download={`quinceanera-recuerdo-${photo.id}.jpg`}
      ...
      <AnimatePresence>
        {zoomPhoto && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[140] bg-[#151110]/98 backdrop-blur-md flex flex-col items-center justify-center p-4 select-none"
